# pyttsx3 is a library that is used a voice engine for any AI model in python
# speech_recognition is used as a voice for the AI model
# time & datetime -> both are used for setting up any current or any specific date and time
# wikipedia library searches content over its official website without opening the web browser
# webbrowser librabry is used to open your default web browser or any specific web browser
# os library represents your Operating System
# smtplib library -> It is also known as Sample Mail Tranfer Protocol Library, is a client session object that can be used to send mail to any internet machine with an SMTP or ESMTP listener daemon.
# cv2 library is a opencv based library that is used to open and record any footage or data based on your device connected camera or any usb drive
